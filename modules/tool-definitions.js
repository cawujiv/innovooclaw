...
const TOOL_DEFINITIONS = {
  ...
  gitStatus:       { name: 'gitStatus',       description: 'Zeigt geänderte Dateien im Git-Repository.',         input_schema: { type: 'object', properties: {} } },
  gitDiff:         { name: 'gitDiff',         description: 'Zeigt den Diff einer Datei oder aller Änderungen.',    input_schema: { type: 'object', properties: { datei: { type: 'string' } } } },
  gitAdd:          { name: 'gitAdd',          description: 'Staged Dateien für den nächsten Commit.',              input_schema: { type: 'object', properties: { datei: { type: 'string', default: '.' } }, required: [] } },
  gitCommit:       { name: 'gitCommit',       description: 'Erstellt einen Git-Commit mit Nachricht.',             input_schema: { type: 'object', properties: { nachricht: { type: 'string' } }, required: ['nachricht'] } },
  gitPush:         { name: 'gitPush',         description: 'Pusht Commits auf das Remote-Repository.',             input_schema: { type: 'object', properties: {} } },
  gitCheckout:     { name: 'gitCheckout',    description: 'Setzt eine Datei auf den letzten Commit-Stand zurück.',  input_schema: { type: 'object', properties: { datei: { type: 'string' } }, required: ['datei'] } },
  gitRevert:       { name: 'gitRevert',      description: 'Macht den letzten Commit rückgängig.',                   input_schema: { type: 'object', properties: {} } },
  gitLog:          { name: 'gitLog',         description: 'Zeigt die letzten 10 Commits.',                          input_schema: { type: 'object', properties: {} } },
  gitPush:         { name: 'gitPush',         description: 'Pusht Commits auf das Remote-Repository.',             input_schema: { type: 'object', properties: {} } },
